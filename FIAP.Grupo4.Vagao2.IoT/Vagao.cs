...
namespace FIAP.Grupo4.Vagao2.IoT
{
    public class Vagao
    {
        ...
        private static async Task SendDeviceToCloudMessagesAsync()
        {
            ...
            do
            {
                ...
                var peopleFlow = new PeopleFlow(peopleEntered, peopleLeft, peopleStayed, 2);
        ...
        {
            Console.WriteLine("Vagao 2 iniciado com sucesso. Ctrl-C to exit.\n");
